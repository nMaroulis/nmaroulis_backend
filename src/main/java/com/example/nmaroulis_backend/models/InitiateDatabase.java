...
//                    "Nikolaou", "nik@gmail.com", "+30 69 823732821", "Athens, Greece","MS.c. in Computer Science", "Data Scientinst at Google", "male", new Title("Data Scientist")  )));
//
//            log.info("Preloading " + repository.save(new User("emily@gmail.com","1234","Emily",
//                    "Tzani", "emily@gmail.com", "+30 69 827732821", "LA California, USA", "BS.c. in Computer Science", "Software Developer at Google", "female", new Title("Android Developer")  )));
//
//            log.info("Preloading " + repository.save(new User( "stathis@gmail.com","1234", "Stathis",
//                    "Papadopoulos", "stathis@gmail.com", "+30 69 823700821", "Athens, Greece","MS.c. in Computer Science", "GO Developer at Google", "male", new Title("Software Developer")  )));
